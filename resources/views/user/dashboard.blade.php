...
<div class="card-columns p-3 ">
    ...
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <h5 class="card-title text-center">Total Insurance Category</h5>
            <h6 class="card-subtitle mb-2 text-center">{{App\Models\Category::count()}}</h6>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <h5 class="card-title text-center">All Month Paid Installment</h5>
            <h6 class="card-subtitle mb-2 text-center">{{App\Models\Installment::where('status', 'paid')->count()}}</h6>
        </div>
    </div>
    <div class="card" style="width: 18rem;">
        <div class="card-body">
            <h5 class="card-title text-center">All  Month Due Installment</h5>
